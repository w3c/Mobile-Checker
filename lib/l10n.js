var messages = {
	...
	,	"compatibility.flash-detection.swfobject-lib-detected": {
		...
		,	"what":"flash detected on the website. This website use swfobject lib. It can not run on a mobile device."
		,	"why":"flash not implemented on mobile devices."
		,	"how": "have to find an other way like HTML5."
		}
	,	"compatibility.flash-detection.swf-file-detected": {
			"title":"flash application detected."
		,	"what":"flash detected on the website. It can not run on a mobile device."
		,	"why":"flash not implemented on mobile devices."
		,	"how": "have to find an other way like HTML5."
		}
	//security
