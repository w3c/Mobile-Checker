...
Checker.prototype.check = function (options) {
    ...
    var step = 0;
    var checklist = [];
    checklist[0] = require("./checks/performance/load-speed");
    checklist[1] = require("./checks/responsive/doc-width");
    checklist[2] = require("./checks/responsive/meta-viewport");
    var reporting = {
        settings : {
...
Checker.prototype.checkout = function () {
    this.checklist[0].check(this);
    this.checklist[1].check(this);
    this.checklist[2].check(this);
};
